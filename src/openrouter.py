...
class OpenRouterService(OpenaiService):
    def construct_curl_command(self, max_tokens, messages, stream_file) -> list:
        data = {
            ...
            # If I want to be safe and consistent with Cerebras which is also OpenAI compatible, I might include it.
            # However, OpenaiService implementation in this repo (from my memory/view_file) does NOT use max_tokens in the body for standard OpenAI.
            # Let's check openai.py again to be sure. I'll stick to OpenaiService pattern unless OpenRouter specifically needs it.
            ...
            # I will omit max_tokens to be consistent with the base `openai.py`, unless I find `openai.py` *should* have it.
        ...
        return [
            ...
            "--header",
            "HTTP-Referer: https://github.com/xuyecan/alfred-chathub",
            "--header",
            "X-Title: Alfred-Chathub",
            "--data",
            json.dumps(data),
            "--output",
            stream_file,
